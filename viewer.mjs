 ...
 * viewer.mjs
 *
 * - Overlay & PDF canvases share the same DPR-backed buffer.
 * - ctx.setTransform(DPR,…) draws in CSS px exactly.
 * - Discrete zoom steps via +/-, updating the dropdown.
 * - Esc closes help overlay.
 * - Click to copy adds a brief “Copied!” tooltip.
 */
...
/** Draw dashed crosshairs and update coordinate displays */
